...
Cons: -artifacts caused by clamp-samling (=> you can try mirror-wrapping)
      -dither-noise is still visible (=> you can increase blur steps)
      -the whole sky casts shafts in this example (you can try manipulating wityh skybox alpha)
